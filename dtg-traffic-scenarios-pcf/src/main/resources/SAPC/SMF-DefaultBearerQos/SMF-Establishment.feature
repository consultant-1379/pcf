Feature: Session Management Policy Establishment with Default Qos and Bandwidth 
  Scenario: SMF_SESSION_ESTABLISMENT
    ...
    Then we expect response content list property policyCtrlReqTriggers equals DEF_QOS_CH,RAT_TY_CH,RE_TIMEOUT,SE_AMBR_CH,USER_LOCATION_CH,US_RE
