  ...
  Scenario: SMF_SESSION_ESTABLISMENT
    ...
    Given request content is
      """
      {
        ...
        "notificationUri": "<SMF_SERVER_SCHEME>://<SMF_SERVER_ADDRESS>:<SMF_SERVER_PORT><smfNotificationUri>/imsi-<imsi>|<pduSessionId>",
        "sliceInfo": {
          "sst": 2,
          "sd": "000002"
        },
    ...
    Then we expect that response header location before % equals <PCF_CLIENT_SCHEME>://<PCF_CLIENT_DESTINATION_HOST>:<PCF_CLIENT_DESTINATION_PORT>/npcf-smpolicycontrol/v1/sm-policies/imsi-<imsi>
