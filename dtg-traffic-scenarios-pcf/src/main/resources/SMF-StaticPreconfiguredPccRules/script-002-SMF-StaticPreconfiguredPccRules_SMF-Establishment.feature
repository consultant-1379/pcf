Feature: Session Management Policy Establishment with Static and Preconfigured PCC rules
  ...
  Scenario: SMF_SESSION_ESTABLISMENT
    ...
    Given request content is
      """
      {
        ...
        "notificationUri": "http://http://10.200.67.66:7072<smfNotificationUri>/imsi-<imsi>|<pduSessionId>",
        "sliceInfo": {
          "sst": 2,
          "sd": "000002"
        },
    ...
    Then we expect response content list property policyCtrlReqTriggers equals RAT_TY_CH,RE_TIMEOUT,SAREA_CH,SE_AMBR_CH,US_RE
    Then we expect response content property $.pccRules contain 8 objects
    ...
    Then we expect response content property $..2001 exist
    ...
    Then we expect response content property  $..qosDecs.QosProfile_GBR exist
    Then we expect response content property  $..qosDecs.QosProfile_nonGBR_default exist
